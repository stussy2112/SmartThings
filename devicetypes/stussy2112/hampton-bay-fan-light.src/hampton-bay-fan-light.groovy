 ...
 */
metadata {
	definition (name: "Hampton Bay Fan Light", namespace: "stussy2112", author: "Sean Williams", ocfDeviceType: "oic.d.switch", mcdSync: true, runLocally: false, executeCommandsLocally: false, mnmn:"SmartThings", vid: "generic-dimmer") {
		capability "Actuator"
...
def installed() {
	...
	state.dimRate = dimRates["Instant"] ?: 0
...
def setLevel(value, rate = null) {
    ...
    parent.childSetLevel(device, value, rate)
}
